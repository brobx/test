...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "C:\\Users\\logar\\Documents\\Projects\\Sites\\quarenhom\\resources\\assets\\js\\admin\\components\\dropzone.vue"
...
},{"vue":69,"vue-hot-reload-api":44,"vueify-insert-css":70}],72:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\logar\\Documents\\Projects\\Sites\\quarenhom\\resources\\assets\\js\\admin\\components\\graph.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"chart.js":2,"vue":69,"vue-hot-reload-api":44}],73:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    watch: {
        uploading: function uploading(value) {
    ...
    methods: {
        ...
        onChange: function onChange(event) {
            ...
            this.$http.post(this.url, formData).then(function (response) {
                ...
                return console.log('Failed to upload image');
            }).then(function () {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\logar\\Documents\\Projects\\Sites\\quarenhom\\resources\\assets\\js\\admin\\components\\image-upload.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"vue":69,"vue-hot-reload-api":44}],74:[function(require,module,exports){
'use strict';
...
var _sliderUpload = require('./slider-upload.vue');

var _sliderUpload2 = _interopRequireDefault(_sliderUpload);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _sliderUpload2.default.extend({});
if (module.exports.__esModule) module.exports = module.exports.default
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\logar\\Documents\\Projects\\Sites\\quarenhom\\resources\\assets\\js\\admin\\components\\inline-slider-upload.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"./slider-upload.vue":75,"vue":69,"vue-hot-reload-api":44}],75:[function(require,module,exports){
'use strict';
...
exports.default = _vue2.default.extend({
    ...
    events: {
        imageUploaded: function imageUploaded(sliderItem) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\logar\\Documents\\Projects\\Sites\\quarenhom\\resources\\assets\\js\\admin\\components\\slider-upload.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"./dropzone.vue":71,"vue":69,"vue-hot-reload-api":44}],76:[function(require,module,exports){
'use strict';
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div>\n    <div class=\"form-group\" v-if=\"! hidden\">\n        <slot>Your Content</slot>\n    </div>\n\n    <button type=\"button\" class=\"btn btn-{{ hidden ? 'primary' : 'danger' }}\" @click=\"hidden = ! hidden\"> {{ hidden ? showText : hideText }}</button>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\logar\\Documents\\Projects\\Sites\\quarenhom\\resources\\assets\\js\\admin\\components\\toggled-field.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"vue":69,"vue-hot-reload-api":44}],77:[function(require,module,exports){
'use strict';
...
module.exports = function (Vue, options) {
    ...
    Vue.directive('disable-after-submit', {
        disableElement: function disableElement() {
...
},{"awesomplete":1}],78:[function(require,module,exports){
(function (process){
'use strict';
...
var _imageUpload = require('./components/image-upload.vue');

var _imageUpload2 = _interopRequireDefault(_imageUpload);

var _sliderUpload = require('./components/slider-upload.vue');

var _sliderUpload2 = _interopRequireDefault(_sliderUpload);

var _toggledField = require('./components/toggled-field.vue');

var _toggledField2 = _interopRequireDefault(_toggledField);

var _inlineSliderUpload = require('./components/inline-slider-upload.vue');

var _inlineSliderUpload2 = _interopRequireDefault(_inlineSliderUpload);

var _graph = require('./components/graph.vue');
...
new _vue2.default({
    ...
    components: {
        ...
        SliderUpload: _sliderUpload2.default,
        ToggledField: _toggledField2.default,
        InlineSliderUpload: _inlineSliderUpload2.default,
