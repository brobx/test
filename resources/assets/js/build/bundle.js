...
},{"./conversions":37}],39:[function(require,module,exports){
/* MIT license */
...
},{"color-name":41}],40:[function(require,module,exports){
/* MIT license */
...
},{"color-convert":38,"color-string":39}],41:[function(require,module,exports){
module.exports = {
	"aliceblue": [240, 248, 255],
	"antiquewhite": [250, 235, 215],
	"aqua": [0, 255, 255],
...
},{"_process":43}],70:[function(require,module,exports){
...
exports.default = {
    ...
    methods: {
        calculate: function calculate() {
            ...
            $(this.$els.button.form).serializeArray().forEach(function (item) {
            ...
            this.$http.post('/' + this.locale + '/api/tools/budget', payload).then(function (response) {
                _this.chartData = response.data.chart;
                _this.recommendations = response.data.recommendations;
                _this.modalInstance.open();
            }).then(function () {
                _this.$broadcast('reloadChart');
            });
        }
    },
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "C:\\Users\\logar\\Documents\\Projects\\Sites\\quarenhom\\resources\\assets\\js\\components\\BudgetCalculator.vue"
  if (!module.hot.data) {
...
},{"./Graph.vue":73,"vue":69,"vue-hot-reload-api":44}],72:[function(require,module,exports){
...
exports.default = {
    ...
    methods: {
        removeListing: function removeListing(id) {
            ...
            var index = this.listings.findIndex(function (item) {
                return item.id == id;
            });
        ...
        init: function init() {
            ...
            this.owl = $('#owlSlider').owlCarousel({
                ...
                margin: 10,
                callbacks: true,
                navigationText: ["<img src='/assets/img/arrow-left-white.png' class='img-responsive'>", "<img src='/assets/img/arrow-right-white.png' class='img-responsive'>"],
                responsive: {
                    0: {
                        items: 1,
                        pagination: false,
    ...
    events: {
        addedListing: function addedListing(id, name, image) {
            var _this = this;

            if (this.listings.filter(function (item) {
                return item.id === id;
            }).length > 0) {
                this.shown = true;
                return;
            ...
            this.listings.push({ name: name, image: image, id: id });
            this.shown = true;
            this.$http.post('/' + this.locale + '/listings/' + id + '/compare', function () {
                _this.reinit();
            });
        }
    },
...
},{"vue":69,"vue-hot-reload-api":44,"vueify-insert-css":70}],73:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    props: {
        type: {
            ...
            validator: function validator(value) {
                return value == 'bar' || value == 'doughnut' || value == 'line' || value == 'pie';
            }
        },
        options: {
            default: function _default() {},
    ...
    methods: {
        ...
        render: function render(data) {
            this.chart = new _chart2.default(this.$els.canvas.getContext('2d'), {
                type: this.type,
                data: data,
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\logar\\Documents\\Projects\\Sites\\quarenhom\\resources\\assets\\js\\components\\Graph.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"chart.js":2,"vue":69,"vue-hot-reload-api":44}],74:[function(require,module,exports){
...
exports.default = {
    ...
    watch: {
        "selectedService.quickFields": function selectedServiceQuickFields() {
    ...
    computed: {
        ...
        advancedUrl: function advancedUrl() {
    ...
    methods: {
        initializeData: function initializeData() {
            if (this.categories) {
                ...
                var items = this.selectedCategory.services;
                var loans = items.filter(function (item) {
                    return item.name == 'Personal Loans' || item.name == 'قرض شخصي';
                })[0];
                var loansIndex = items.indexOf(loans);
                var credit = items[0];
                items[0] = loans;
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\logar\\Documents\\Projects\\Sites\\quarenhom\\resources\\assets\\js\\components\\QuickSearch.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n.comparassion .comp-item.active i {\n    background-color: #23aae1;\n    color: #fff;\n    border-color: #23aae1;\n}\n\n.comparassion .comp-item.active .comp-name {\n    color: #ddd;\n}\n.filter-item:nth-child(3) { \n    clear: both; \n}\n"] = false
    document.head.removeChild(__vueify_style__)
  })
...
},{"vue":69,"vue-hot-reload-api":44,"vueify-insert-css":70}],75:[function(require,module,exports){
...
exports.default = {
	...
	methods: {
		search: function search() {
			...
			this.$http.get('/' + this.locale + '/help/search/', { q: this.query }).then(function (response) {
				_this.results = response.data.hits;
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\logar\\Documents\\Projects\\Sites\\quarenhom\\resources\\assets\\js\\components\\SearchHelp.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n.search-help-container {\n\tposition: relative;\n}\n.search-help {\n\tbackground: #fff;\n\ttext-align: start;\n\tposition: absolute;\n\twidth: 100%;\n}\n.search-help li {\n\tmargin: 0;\n}\n.search-help li a {\n\tpadding: 10px 20px;\n\tdisplay: block;\n\tborder-bottom: 1px solid #ccc;\n}\n.search-help li:last-child a {\n\tborder-bottom: 0;\n}\n.search-help li a:hover {\n\ttext-decoration: none;\n\tbackground: #fafafa;\n}\n.search-help.no-result {\n\tpadding: 5px 15px;\n\tfont-style: italic;\n}\n"] = false
    document.head.removeChild(__vueify_style__)
  })
...
},{"vue":69,"vue-hot-reload-api":44,"vueify-insert-css":70}],76:[function(require,module,exports){
'use strict';
...
module.exports = function (Vue, options) {
    ...
    Vue.directive('slider', {
        ...
        bind: function bind() {
            ...
            var valueInput = document.getElementById(this.params.inputId);
            var valueSpan = document.getElementById(this.params.spanId);
            var self = this;
            this.el.noUiSlider.on('update', function (values, handle) {
                ...
                if (valueSpan) {
                    var commaValue = self.addCommas(parseFloat(values[handle]));
    ...
    Vue.directive('show-where', {
        ...
        isRadio: function isRadio() {
            var input = $(':input[name=\'' + this.params.fieldName + '\']');

            return input.length && input[0].type == "radio";
        },
        onRadioChange: function onRadioChange() {
            this.elSelector.toggleClass('hidden', $(':input[name=\'' + this.params.fieldName + '\']:checked').val() != this.params.whereValue);
        ...
        onChange: function onChange() {
            this.elSelector.toggleClass('hidden', $(':input[name=' + this.params.fieldName + ']').val() != this.params.whereValue);
    ...
    Vue.directive('autocomplete', {
        ...
        awesomplete: null,
        bind: function bind() {
            this.awesomplete = new _awesomplete2.default(this.el, {
                minChars: 2,
                autoFirst: true
            });
        ...
        onKeyUp: function onKeyUp() {
            ...
            var url = 'http://where.yahooapis.com/v1/places.q(\'*' + this.el.value + '*\');count=10?';
            var lang = window.location.pathname.split('/')[1] == 'en' ? 'en-US' : 'ar-EG';
            this.vm.$http.jsonp(url, { format: 'json', lang: lang, appid: this.params.apiKey }).then(function (response) {
                _this.awesomplete.list = response.data.places.place.map(function (place) {
...
},{"awesomplete":1}],77:[function(require,module,exports){
(function (process){
'use strict';
...
var _QuickSearch = require('./components/QuickSearch.vue');

var _QuickSearch2 = _interopRequireDefault(_QuickSearch);

var _SearchHelp = require('./components/SearchHelp.vue');

var _SearchHelp2 = _interopRequireDefault(_SearchHelp);

var _BudgetCalculator = require('./components/BudgetCalculator.vue');

var _BudgetCalculator2 = _interopRequireDefault(_BudgetCalculator);

var _ComparisonSlider = require('./components/ComparisonSlider.vue');

var _ComparisonSlider2 = _interopRequireDefault(_ComparisonSlider);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_vue2.default.use(_vueResource2.default);
_vue2.default.use(require('./directives'));
...
_vue2.default.http.headers.common['Access-Control-Allow-Methods'] = '*';
_vue2.default.http.headers.common['Access-Control-Allow-Headers'] = 'Content-Type, Content-Range, Content-Disposition, Content-Description';
...
new _vue2.default({
    ...
    components: {
        ...
        SearchHelp: _SearchHelp2.default,
        BudgetCalculator: _BudgetCalculator2.default,
        ComparisonSlider: _ComparisonSlider2.default
    }
});
